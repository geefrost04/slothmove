...
document.addEventListener('DOMContentLoaded', function() {
        ...
        document.body.innerHTML = `
            <nav class="nav" id="navbar">
                <div class="nav-inner">
                    <a href="../index.html" class="nav-logo">
                        <img src="../pic/logo_police.png" alt="Police">
            ...
            <main class="page-content">
                    ...
                    <div class="hero-inner">
                        <div class="hero-content">
                            <div class="hero-badge">
                                ...
                                <span id="hero-section-label">สายอำนวยการ</span>
                            </div>
                            <h1 class="hero-title">
                                <span class="hl-sub" id="hero-title-sub">เตรียมสอบ</span>
                                นายสิบตำรวจ<br>
                                <span class="hl-yellow" id="hero-title-short">สายอำนวยการ</span>
                            </h1>
                ...
                <section class="org-chart-section" id="section-s2" style="scroll-margin-top: 72px;">
                    <div class="container">
                        <div class="sec-break"><span class="sec-break-label">ส่วนที่ 2 · โครงสร้าง</span></div>
                        <h2 style="font-family:var(--font-display); font-weight:900; font-size:clamp(1.5rem,3vw,2.2rem); color:var(--text); text-align:center; margin-bottom:var(--space-sm);">โครงสร้างราชการ</h2>
                ...
                <section class="glossary-section" id="section-s3" style="scroll-margin-top: 72px;">
                    <div class="container">
                        ...
                        <p style="font-family:var(--font-body); font-size:0.88rem; color:var(--text-muted); margin-bottom:var(--space-lg);">ศัพท์เชิงกฎหมาย ระเบียบ และคำศัพท์ที่เกี่ยวข้อง</p>
            ...
            <footer class="footer-section">
                    <div class="footer-inner">
                        <div class="footer-brand">
                            <img src="../pic/logo_police.png" alt="Police" class="footer-logo">
                        ...
                        <div class="footer-actions">
                            ...
                            <a href="../index.html" class="footer-back-btn">กลับหน้าคอร์ส →</a>
                        </div>
                    </div>
    ...
    function loadQuizPage() {
        ...
        document.body.innerHTML =
            ...
            '<img src="' + picBase + 'logo_police.png" alt="Police">' +
            'Sloth<span class="logo-accent">Move</span>' +
            '<span class="logo-sep">|</span><span class="logo-sub">สายอำนวยการ</span></a>' +
            '<div class="nav-center">' +
            ...
            '<span class="start-badge">แบบทดสอบ · เตรียมสอบสายอำนวยการ</span>' +
            '<span class="start-icon">🏛️</span>' +
            '<h1 class="start-title">เตรียมสอบนายสิบตำรวจ<br>สายอำนวยการ</h1>' +
            '<p class="start-title-sub">สำนักงานตำรวจแห่งชาติ</p>' +
            '<p class="start-desc">เตรียมพร้อมสอบราชการ พร้อมเฉลยทุกข้อ</p>' +
            '<div class="start-tags">' +
            '<span class="start-tag">📋 ข้อสอบเสมือนจริง</span>' +
            '<span class="start-tag">🏛️ อัปเดตล่าสุด</span>' +
            '<span class="start-tag">✏️ มีเฉลยละเอียด</span></div>' +
            ...
            '<div class="qr-card"><img src="../../../../pic/qr.jpg" alt="QR พร้อมเพย์" loading="lazy">' +
            '<p class="qr-note">* สแกนผ่านแอปธนาคารทุกแห่ง</p></div></div></div>' +

            '<footer class="footer-section"><div class="footer-inner">' +
            '<div class="footer-brand"><img src="' + picBase + 'logo_police.png" alt="Police" class="footer-logo">' +
